...
Source: ..\libs\logmett\Setup_LogMeTT_2_9_9_1.exe; DestDir: {tmp}; Components: LogMeTT; Flags: deleteafterinstall
Source: ..\libs\logmett\Setup_TTLEditor_1_3.exe; DestDir: {tmp}; Components: TTLEdit; Flags: deleteafterinstall
...
Filename: {tmp}\Setup_LogMeTT_2_9_9_1.exe; Components: LogMeTT
Filename: {tmp}\Setup_TTLEditor_1_3.exe; Components: TTLEdit
