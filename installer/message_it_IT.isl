...
msg_uninstall_confirm=Sembra che sia installata una versione precedente.%n%nTi consigliamo prima di disinstallare la versione precedente.%n%nVuoi disinstallare la versione precedente?
...
comp_TTXKcodechange=Modifica codice Kanji giapponese da sequenza remota
comp_TTXViewMode=Può essere usata la modalità 'Sola visualizzazione'
comp_TTXAlwayontop=Può essere usato 'Sempre in primo piano'
